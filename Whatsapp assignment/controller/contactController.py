...
from environment.Router import contact_router
...
controller = Controller(contact_router)
logger = Logger.get_logger(__name__)

@controller.use()
@controller.resource()
class ContactController:
    def __init__(self, contactService:ContactService = Depends()) -> None:
        # print("dsfs")
        # self.userService = userService
        self.contactServie = contactService
        # self.messageService = messageService

    @controller.route.get("/{user_id}/contacts", summary="return the user from the database", response_model=None)
    def getContactsOfUser(self, user_id:str= None) :
